(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Update_vue"],{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get("/api/products/".concat(_this.$route.params.id)).then(function (response) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().put("/api/products/update/".concat(_this2.$route.params.id), _this2.product).then(function (response) {
                  _this2.$router.push({
                    name: "home"
                  });
                });
